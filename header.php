...
$pageTitles = [
    ...
    "view_all" => "Publications",
    "view_all_announcements" => "Announcements"
];
...
<body class="service-details-page">
  ...
  <header id="header" class="header dark-background d-flex flex-column">
    ...
    <div class="social-links text-center">
      ...
      <a href="https://www.linkedin.com/in/Dr. Ashim Raj Singla" class="linkedin" target="_blank"><i class="bi bi-linkedin"></i></a>
    </div>
    ...
    <nav id="navmenu" class="navmenu">
      <ul>
        <?php if ($pageName == 'index') { ?>
          ...
          <li><a href="#publications"><i class="bi bi-images navicon"></i> Publications</a></li>
          <li><a href="#courses"><i class="bi bi-hdd-stack navicon"></i> Courses</a></li>
          <li><a href="#contact"><i class="bi bi-envelope navicon"></i> Contact</a></li>
          <li><a href="gallery.php" target='_blank'><i class="bi bi-images navicon"></i> Gallery</a></li>
        <?php } else { ?>
          <!-- ✅ Other Pages: Only Home Link -->
