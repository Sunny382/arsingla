...
if (strlen($_SESSION['tsasaid']==0)) {
    ...
    if(isset($_POST['submit']))
  {
    ...
    $sql = "UPDATE announcements SET title=:title, message=:message, expiry_date=:expiry_date WHERE ID=:eid";
...
<html lang="en">
<head> 
    <title>TSAS : Announcement Update</title>
    <!-- Styles -->
                            ...
                            <div class="card alert">
                                <div class="card-header pr">
                                    ...
                                    <form method="post" name="hjhgh">
                                        <?php
                                            $eid=$_GET['editid'];
                                            $sql="SELECT * from announcements where ID=$eid";
                                            $query = $dbh -> prepare($sql);
                                            $query->execute();
                                        ...
                                        <div class="basic-form m-t-20">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control border-none input-flat bg-ash" name="message" required="true"><?php echo htmlentities($row->message); ?></textarea>
                                            </div>
                                        </div>  
                                        ...
                                        <div class="basic-form m-t-20">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control border-none input-flat bg-ash" value="<?php echo htmlentities($row->expiry_date);?>" name="expiry_date" required="true">
                                            </div>
                                        </div> 
                                        <?php $cnt=$cnt+1;}} ?> 
