...
if (strlen($_SESSION['tsasaid']==0)) {
  header('location:logout.php');
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql = "INSERT INTO tblcourse (CourseName, course_code, description, icon_class) VALUES (:coursename, :coursecode, :description, :iconclass)";
                                    ...
                                    <form method="post" name="hjhgh">
                                        ...
                                        <div class="basic-form m-t-20">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control border-none input-flat bg-ash" placeholder="Course Code" name="coursecode" required="true">
                                            </div> 
                                        </div>
                                        <div class="basic-form m-t-20">
                                            <div class="form-group">
                                                <label>Description</label>
                                                <textarea class="form-control border-none input-flat bg-ash" placeholder="Course Description" name="description" required="true"></textarea>
                                            </div> 
                                        </div>
                                        <div class="basic-form m-t-20">
                                            <div class="form-group">
                                                <label>Icon Class</label>
                                                <input type="text" class="form-control border-none input-flat bg-ash" placeholder="e.g., bi bi-briefcase" name="iconclass" required="true">
                                            </div> 
                                        </div>                                
